...
//        return productRepository.findProducts(brandIds, categoryId, pageable);
    }
...
//        }
        ...
        if (all.isEmpty()) {
            ...
            product.setBrand(brandRepository.findByTitleIgnoreCase("BACCARAT").orElse(brandService.findAll(Pageable.unpaged()).getContent().get(0)));
//            product.setCollection(collectionService.findAll(Pageable.unpaged()).getContent().get(0));
            ...
            product_hermes.setBrand(brandRepository.findByTitleIgnoreCase("HERMES").orElse(brandService.findAll(Pageable.unpaged()).getContent().get(0)));
//            product.setCollection(collectionService.findAll(Pageable.unpaged()).getContent().get(0));
            ...
            product2.setBrand(brandRepository.findByTitleIgnoreCase("BACCARAT").orElse(brandService.findAll(Pageable.unpaged()).getContent().get(0)));
//            product2.setCollection(collectionService.findAll(Pageable.unpaged()).getContent().get(0));
            ...
            product2_hermes.setBrand(brandRepository.findByTitleIgnoreCase("HERMES").orElse(brandService.findAll(Pageable.unpaged()).getContent().get(0)));
//            product2.setCollection(collectionService.findAll(Pageable.unpaged()).getContent().get(0));
            ...
            product3.setBrand(brandRepository.findByTitleIgnoreCase("BACCARAT").orElse(brandService.findAll(Pageable.unpaged()).getContent().get(0)));
//            product2.setCollection(collectionService.findAll(Pageable.unpaged()).getContent().get(0));
            ...
            product3_hermes.setBrand(brandRepository.findByTitleIgnoreCase("HERMES").orElse(brandService.findAll(Pageable.unpaged()).getContent().get(0)));
//            product2.setCollection(collectionService.findAll(Pageable.unpaged()).getContent().get(0));
            product3_hermes.setCategory(category4);
            product3_hermes.setType(plates);
            product3_hermes.setType(typeService.findAll(Pageable.unpaged()).getContent().get(0));
            create(product3_hermes);
        }
    }
